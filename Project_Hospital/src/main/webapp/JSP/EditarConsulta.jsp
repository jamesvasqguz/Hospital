<%-- 
    ...
    Created on : 27/09/2020, 04:46:18
    Author     : jara
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container mt-5">
            <h3>Solo el Costo de la Consulta puede Modificar</h3>            
            <div class="row">
                <div class="col-sm">
                    <%
                    ...
                    %>
                    <form action="/Project_Hospital/ModificarConsulta" method="post">
                        <div class="form-group">
                            <label>Especialidad</label>
                            <input type="text" class="form-control" name="especialidad" value="<%= espe%>" readonly>
                        </div>
                        <div class="form-group">
                            <label>Costo de la Consulta</label>
                            <input type="text" class="form-control" name="costo" value="<%= cost%>">
                        </div>
                        <button type="submit" class="btn btn-primary" name="entrar">Editar Consulta</button>
                        <a href="CrearConsulta.jsp" class="btn btn-danger">Regresar</a>
                    </form>
                    <br>
                </div>
            </div>
